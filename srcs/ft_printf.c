...
/*   Updated: 2025/12/30 03:36:40 by aphyo-ht         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param upper Character indicating case: 'X' for uppercase hex,
	'x'/'u' for lowercase
 ...
 *
 * This function processes different format specifiers like %s, %d, %i, %u, %x,
	%X, %p
