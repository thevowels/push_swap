...
/*   Updated: 2025/12/30 03:41:19 by aphyo-ht         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * Performs the swap operation on the first stack
	and optionally on a second stack.
 ...
 * @param second Pointer to the second stack to
		swap (NULL for single stack operations)
 * @param command String representation of the command to print (e.g., "sa",
	"sb", "ss")
 *
 ...
 * Pops the top element from the source stack and
	pushes it to the destination stack.
 ...
 * @param command String representation of the command to print (e.g., "pa",
	"pb")
 *
 ...
 *
 * Performs the rotate operation on the first stack and optionally
	on a second stack.
 ...
 * @param second Pointer to the second stack to
	rotate (NULL for single stack operations)
 * @param command String representation of the command to print (e.g., "ra",
	"rb", "rr")
 *
 ...
 *
 * Performs the reverse rotate operation on the first stack and 
	optionally on a second stack.
 * Reverse rotate shifts all elements down by 1,
	making the last element become the first.
 ...
 * @param second Pointer to the second stack to reverse rotate (NULL for
	single stack operations)
 * @param command String representation of the command to print (e.g., "rra",
	"rrb", "rrr")
 *
